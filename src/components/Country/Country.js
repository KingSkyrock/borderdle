    ...
    return (
      <div className="flex flex-col items-center pt-3">
        <JsxParser
          ...
          jsx={"<svg ref={this.svg} className='pb-1' xmlns='http://www.w3.org/2000/svg' version='1.0' width='208px' height='208px' viewBox='0 0 280 280'><g id='border' transform='translate(0.000000,1024.000000) scale(0.1,-0.1)' fill='none' stroke='#1e293b' strokeWidth='100px'>"+this.state.paths+"</g></svg>"}
